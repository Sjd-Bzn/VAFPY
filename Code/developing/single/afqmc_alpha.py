...
hamil.one_body = H1.astype(np.complex64)
...
H2 = np.array(read_datafile(input_file_two_body_hamil),dtype=np.complex64)
...
alp = np.einsum('pi, prg -> irg',PSI_T_up , hamil.two_body).astype(np.complex64)
alp_t = np.einsum('pi, rpg -> irg', PSI_T_up, hamil.two_body.conj()).astype(np.complex64)
#print('alp', alp.dtype)
#print('alpha_t done')
...
#del(hamil)
#print('hamil mf', h2_af_MF_sub.dtype)
