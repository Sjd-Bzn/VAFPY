from afqmc_funcs_kpts_0 import *
...
hamil = HAMILTONIAN
h1 = np.array(read_datafile(input_file_one_body_hamil), order='F')
#h1 = np.zeros_like(h1)

hamil.two_body = np.array(read_datafile(input_file_two_body_hamil), order='F')
if first_cpu:
