...
if num_k==64:
    fsg = 4.98497720077895 
    input_file_one_body_hamil = 'H1_1.npy'
    input_file_two_body_hamil = 'H2_zip_1.npy'
...
if SPIN==0:
    output_file = '1_AFQMC_CS_num_k'+str(num_k)+'_'+system+'_'+str(UPDATE_METHOD)+'_Reortho_'+str(REORTHO_PERIODICITY) +'_Rebal_'+str(REBAL_PERIODICITY)+'_TAU_'+str(D_TAU)+'.txt'
