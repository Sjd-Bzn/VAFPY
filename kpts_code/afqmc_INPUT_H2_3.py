...
if num_k==8:
    fsg = 9.58493583727009
    input_file_one_body_hamil = 'H1_3.npy'
    input_file_two_body_hamil = 'H2_zip_3.npy'
...
if SPIN==0:
    output_file = '3_AFQMC_CS_num_k'+str(num_k)+'_'+system+'_'+str(UPDATE_METHOD)+'_Reortho_'+str(REORTHO_PERIODICITY) +'_Rebal_'+str(REBAL_PERIODICITY)+'_TAU_'+str(D_TAU)+'.txt'
