...
if num_k==8:
    fsg = 8.96537724702830 
    input_file_one_body_hamil = 'H1_7.npy'
    input_file_two_body_hamil = 'H2_zip_7.npy'
...
if SPIN==0:
    output_file = '7_AFQMC_CS_num_k'+str(num_k)+'_'+system+'_'+str(UPDATE_METHOD)+'_Reortho_'+str(REORTHO_PERIODICITY) +'_Rebal_'+str(REBAL_PERIODICITY)+'_TAU_'+str(D_TAU)+'.txt'
